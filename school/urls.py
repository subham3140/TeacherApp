...
urlpatterns = [
    ...
    path('passwordresetdone/', auth_views.PasswordResetDoneView.as_view(template_name = 'passworddone.html'), name = 'password_reset_done'),
    ...
    path('passwordresetcomplete/', auth_views.PasswordResetCompleteView.as_view(template_name = 'passwordcomplete.html'), name = 'password_reset_complete'),
